    ...
    <div class="index-header">
        <img src="static/imgs/hd_bg.png" alt="" class="head-bg"/>
        <div class="index-logo">
            <img src="static/imgs/jh.png" alt="" class="head-logo"/>
        </div>
        <div class="head-title">
            <h1>城市车辆智能防控系统</h1>
            <h2>Urban vehicle intelligent control system</h2>
        </div>
        <div class="head-user">
            你好：<a href="javascript:;">admin</a>
        </div>
    </div>
    <div class="head-nav">
        <ul class="nav-bar">
