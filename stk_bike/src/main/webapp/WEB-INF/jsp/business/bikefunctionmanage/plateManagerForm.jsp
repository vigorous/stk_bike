	...
	<form action="" id="form">
		...
		<div class="row row-margin-top">
			<div class="col-xs-12">
				...
				<div class="col-xs-6 no-padding-left">
					<input type="text" id="AUTH_ORG_NAME" name="AUTH_ORG_NAME" value="" />
				</div>
			</div>
		</div>
		...
		<div class="row row-margin-top">
			<div class="col-xs-12">
				<label class="col-xs-5 no-padding-right dialog-text text-rt" for=""> 申请时间： </label>
				<div class="col-xs-6 no-padding-left">
					<div class="col-xs-8 no-padding-left">
						<input class="form-control datetime-picker" type="text" id="APPLY_TIME" name="APPLY_TIME" value="" />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row row-margin-top">
			<div class="col-xs-12">
				<label class="col-xs-5 no-padding-right dialog-text text-rt" for=""> 开始号码： </label>
				<div class="col-xs-6 no-padding-left">
					<input type="text" id="CARD_BEGIN_NO" name="CARD_BEGIN_NO" value="" />
				</div>
			</div>
		</div>
		...
		<div class="row row-margin-top">
			<div class="col-xs-12">
				<label class="col-xs-5 no-padding-right dialog-text text-rt" for=""> 结束号码： </label>
				<div class="col-xs-6 no-padding-left">
		...
		<div class="row row-margin-top">
			<div class="col-xs-12">
				<label class="col-xs-5 no-padding-right dialog-text text-rt" for=""> 卡片数量： </label>
				<div class="col-xs-6 no-padding-left">
		...
		<div class="row row-margin-top">
			<div class="col-xs-12">
				<label class="col-xs-5 no-padding-right dialog-text text-rt" for=""> 经办人ID： </label>
				<div class="col-xs-6 no-padding-left">
					<div class="col-xs-8 no-padding-left">
						<select class="form-control col-xs-8" name="manageID" id="manageID">
		...
		<div class="row row-margin-top">
			<div class="col-xs-12">
				...
				<input onclick="save()" class="btn btn-sm btn-success" id="add" type="button"
						value="保存" />
				</div>
				<div class="col-xs-3">
