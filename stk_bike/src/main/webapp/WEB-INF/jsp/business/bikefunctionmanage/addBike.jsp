	...
	<div class="dialog-content">
		...
		<div class="row row-margin-top">
			<div class="col-xs-6">
				...
				<input type="text" name="BIKE_TYPE" value="" />
			</div>
		...
		<div class="row row-margin-top">
			<div class="col-xs-6">
				...
				<input type="text" value="" name="BIKE_COLOR"  />
			</div>
			
			<div class="col-xs-6">
				<label class="col-xs-5 no-padding-right dialog-text text-rt" for=""> 车辆型号： </label>
				<input type="text" value="" name="BIKE_MODEL" />
			</div>
		</div>
		...
		<div class="row row-margin-top">
			<div class="col-xs-6">
				...
				<input type="text" value="" name="BIKE_SKELETON_NO" />
			</div>
		...
		<div class="row row-margin-top">
			<div class="col-xs-6">
				...
				<input type="text" value="" name="OWNER_SFID" />
			</div>
		...
		<div class="row row-margin-top">
			<div class="col-xs-6">
				...
				<input type="text" name="OWNER_ADDRESS" value="" />
			</div>
			
			<div class="col-xs-6">
				<label class="col-xs-5 no-padding-right dialog-text text-rt" for=""> 车主工作单位： </label>
				<input type="text" name="OWNER_COMPANY" value="" />
			</div>
		</div>
		...
		<div class="row row-margin-top">
			<div class="col-xs-6">
				...
				<input type="text" value="" name="OWNER_PHONE" />
			</div>
		...
		<div class="row row-margin-top">
			<div class="col-xs-6">
				...
				<input type="text" name="REGISTER_TIME" value="" />
			</div>
			
			<div class="col-xs-6">
				<label class="col-xs-5 no-padding-right dialog-text text-rt" for=""> 车主身份证号： </label>
				<input type="text" name="OWNER_SFID" value="" />
			</div>
		</div>
		...
		<div class="row row-margin-top">
			...
			<div class="col-xs-6">
				...
				<div class="col-xs-6 no-padding-left">
					<select class="form-control" name="POLICE_ID">
						<option value="01">111</option>
						<option value="00">222</option>
					</select>
				</div>
			</div>
		</div>
		...
		<div class="row row-margin-top">
			...
			<div class="col-xs-6">
				...
				<input type="text" name="POLICE_OFFICE_ID" value="" />
			</div>
		</div>
