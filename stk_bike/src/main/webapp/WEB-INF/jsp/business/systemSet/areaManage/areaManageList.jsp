...
<body class="no-skin">
		...
		<div class="row">
			<div class="col-xs-12">
				<table
					...
					id="areaManageListTable">
					<thead>
						<tr>
							<th class="text-center" width="10%"><label class="pos-rel">
	...
	<script type="text/javascript"
		src="static/js/private_js/business/systemSet/areaManage/areaManageList.js"></script>
</body>
</html>